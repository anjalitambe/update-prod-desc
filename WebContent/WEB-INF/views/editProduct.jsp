...
<form:form method="post" action="${url}" commandName="editProductObj"> 
  <div class="row">
                  <div class="col-25">
                  <form:label path="productId">Product Id<span style="color: red">*</span></form:label>
								
					</div>
					 <div class="col-75">
                   <form:input type="number" placeholder=" ProductId.."
									class="form-control" path="productId" ></form:input><br> 
          </div>
                ...
                <div class="row">
                  <div class="col-25">
                    <form:label path="productName"> Product Name:<span style="color: red">*</span></form:label>
                  </div>
                  <div class="col-75">
                    <form:input type="text" placeholder="Enter Product Name.."
									class="form-control" path="productName"></form:input><br>	
          </div>
                </div>
                <div class="row">
                  <div class="col-25">
                   <form:label path="productDescription">Product Description:<span style="color: red">*</span></form:label>
                  </div>
                  <div class="col-75">
                    
								<form:textarea type="text" placeholder="Enter V"
								class="form-control" path="productDescription"></form:textarea><br>	
								<br>
									   </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-25">
                                  <form:label path="productCategory">Product Category:<span style="color: red">*</span></form:label>
                                </div>
                              ...
                              <div class="row">
                                  <div class="col-25">
                                    <form:label path="productPrice"> Product Price:<span style="color: red">*</span></form:label>
                                  </div>
                                  <div class="col-75">
                                    <form:input 
                ...
                <div class="row">
                <center>
                    <button type="submit" style="text-align: center" class="aa-browse-btn">Update</a></button>  
                     </center>  </div>
                 </form:form>
              </div>              
            </div>          
